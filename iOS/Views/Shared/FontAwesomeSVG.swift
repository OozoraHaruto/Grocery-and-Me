...
struct FontAwesomeSVG: NSViewRepresentable {
  ...
  var color2: CGColor? = NSColor(red: 1, green: 1, blue: 1, alpha: 0.5).cgColor
...
//    svgLayer.position = svgView.centerXAnchor
//    svgView.layer.addSublayer(svgLayer)
  ...
  func getColor2() -> CGColor {
    ...
    if(color2!.components == NSColor(red: 1, green: 1, blue: 1, alpha: 0.5).cgColor.components && color !=  Color.white.cgColor){
